...
public class EnumDemo {
	/*
	 * enum (short for enumerated type) is a way to categorize a set of states or
	 * values into their own type.
	 */
	...
	/*
	 * enums can be defined within a class as shown in this demo or within their own
	 * files as shown in StatesOfMatter.java.
	 */
	...
	enum Planets {
		...
		/*
		 * In the case of an enum we can make our constructor private because the
		 * default value is passed internally and enums do not require the "new" keyword
		 * to be initialized.
		 */
	...
	public static void main(String[] args) {
		...
		if (planet == Planets.MERCURY) {
			...
			System.out.println(planet + " takes " + planet.getDaysToOrbitSun() + " days to orbit the sun!");

		}

		/*
		 * The .values() method returns every unique entry of an enum as an array.
		 */

		Planets[] planets = Planets.values();

		/*
		 * The planet variable can then be set to any random value in planets through
		...
		/*
		 * Notice that the name of the enum's type is not required for the cases in the
		 * switch statement.
		 */
